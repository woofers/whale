...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		type.set ("assets/images/ui/pause/darken.png", AssetType.IMAGE);
		...
		type.set ("assets/images/ui/pause/pause.png", AssetType.IMAGE);
		...
		type.set ("assets/images/ui/pause/score.png", AssetType.IMAGE);
