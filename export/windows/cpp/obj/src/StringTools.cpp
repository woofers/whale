...
::String StringTools_obj::urlEncode( ::String s){
	HX_STACK_FRAME("StringTools","urlEncode",0x06afdce1,"StringTools.urlEncode","D:\\Documents\\Development\\HAXE\\haxe\\std/StringTools.hx",46,0x38ee690b)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(46)
...
::String StringTools_obj::urlDecode( ::String s){
	HX_STACK_FRAME("StringTools","urlDecode",0x71b947f9,"StringTools.urlDecode","D:\\Documents\\Development\\HAXE\\haxe\\std/StringTools.hx",71,0x38ee690b)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(71)
...
::String StringTools_obj::htmlEscape( ::String s,Dynamic quotes){
	HX_STACK_FRAME("StringTools","htmlEscape",0x0e1a5dd0,"StringTools.htmlEscape","D:\\Documents\\Development\\HAXE\\haxe\\std/StringTools.hx",97,0x38ee690b)
	HX_STACK_ARG(s,"s")
...
bool StringTools_obj::startsWith( ::String s,::String start){
	HX_STACK_FRAME("StringTools","startsWith",0x5f4e6efb,"StringTools.startsWith","D:\\Documents\\Development\\HAXE\\haxe\\std/StringTools.hx",133,0x38ee690b)
	HX_STACK_ARG(s,"s")
...
bool StringTools_obj::endsWith( ::String s,::String end){
	HX_STACK_FRAME("StringTools","endsWith",0x0eb5bfe2,"StringTools.endsWith","D:\\Documents\\Development\\HAXE\\haxe\\std/StringTools.hx",144,0x38ee690b)
	HX_STACK_ARG(s,"s")
...
bool StringTools_obj::isSpace( ::String s,int pos){
	HX_STACK_FRAME("StringTools","isSpace",0xe0290778,"StringTools.isSpace","D:\\Documents\\Development\\HAXE\\haxe\\std/StringTools.hx",165,0x38ee690b)
	HX_STACK_ARG(s,"s")
...
::String StringTools_obj::ltrim( ::String s){
	HX_STACK_FRAME("StringTools","ltrim",0x24d2234a,"StringTools.ltrim","D:\\Documents\\Development\\HAXE\\haxe\\std/StringTools.hx",179,0x38ee690b)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(183)
...
::String StringTools_obj::rtrim( ::String s){
	HX_STACK_FRAME("StringTools","rtrim",0x99399e50,"StringTools.rtrim","D:\\Documents\\Development\\HAXE\\haxe\\std/StringTools.hx",204,0x38ee690b)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(208)
	int l = s.length;		HX_STACK_VAR(l,"l");
	HX_STACK_LINE(209)
...
::String StringTools_obj::trim( ::String s){
	HX_STACK_FRAME("StringTools","trim",0x2908d066,"StringTools.trim","D:\\Documents\\Development\\HAXE\\haxe\\std/StringTools.hx",226,0x38ee690b)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(232)
...
::String StringTools_obj::replace( ::String s,::String sub,::String by){
	HX_STACK_FRAME("StringTools","replace",0x6d651f30,"StringTools.replace","D:\\Documents\\Development\\HAXE\\haxe\\std/StringTools.hx",303,0x38ee690b)
	HX_STACK_ARG(s,"s")
