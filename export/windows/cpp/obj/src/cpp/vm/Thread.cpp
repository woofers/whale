...
{
HX_STACK_FRAME("cpp.vm.Thread","new",0x66262c28,"cpp.vm.Thread.new","D:\\Documents\\Development\\HAXE\\haxe\\std/cpp/vm/Thread.hx",31,0x1fec14df)
HX_STACK_THIS(this)
HX_STACK_ARG(h,"h")
{
	HX_STACK_LINE(31)
...
::cpp::vm::Thread Thread_obj::current( ){
	HX_STACK_FRAME("cpp.vm.Thread","current",0x21a37c01,"cpp.vm.Thread.current","D:\\Documents\\Development\\HAXE\\haxe\\std/cpp/vm/Thread.hx",45,0x1fec14df)
	HX_STACK_LINE(46)
...
::cpp::vm::Thread Thread_obj::create( Dynamic callb){
	HX_STACK_FRAME("cpp.vm.Thread","create",0xb01a9834,"cpp.vm.Thread.create","D:\\Documents\\Development\\HAXE\\haxe\\std/cpp/vm/Thread.hx",52,0x1fec14df)
