...
{
HX_STACK_FRAME("haxe.xml._Fast.HasAttribAccess","new",0x4d025ce8,"haxe.xml._Fast.HasAttribAccess.new","D:\\Documents\\Development\\HAXE\\haxe\\std/haxe/xml/Fast.hx",67,0xa7b64698)
HX_STACK_THIS(this)
HX_STACK_ARG(x,"x")
{
	HX_STACK_LINE(67)
...
bool HasAttribAccess_obj::resolve( ::String name){
	HX_STACK_FRAME("haxe.xml._Fast.HasAttribAccess","resolve",0x0ac38374,"haxe.xml._Fast.HasAttribAccess.resolve","D:\\Documents\\Development\\HAXE\\haxe\\std/haxe/xml/Fast.hx",70,0xa7b64698)
	HX_STACK_THIS(this)
