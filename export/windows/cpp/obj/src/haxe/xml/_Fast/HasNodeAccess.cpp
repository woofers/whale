...
{
HX_STACK_FRAME("haxe.xml._Fast.HasNodeAccess","new",0xd184aba0,"haxe.xml._Fast.HasNodeAccess.new","D:\\Documents\\Development\\HAXE\\haxe\\std/haxe/xml/Fast.hx",83,0xa7b64698)
HX_STACK_THIS(this)
HX_STACK_ARG(x,"x")
{
	HX_STACK_LINE(83)
