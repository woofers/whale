...
{
HX_STACK_FRAME("PauseMenu","new",0x4a0c6b07,"PauseMenu.new","PauseMenu.hx",19,0x1d081249)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("PauseMenu","create",0x4e95aeb5,"PauseMenu.create","PauseMenu.hx",51,0x1d081249)
		HX_STACK_THIS(this)
		HX_STACK_LINE(52)
		this->super::create();
		HX_STACK_LINE(55)
...
{
		HX_STACK_FRAME("PauseMenu","update",0x598bcdc2,"PauseMenu.update","PauseMenu.hx",105,0x1d081249)
		HX_STACK_THIS(this)
		HX_STACK_LINE(105)
		this->super::update();
	}
...
{
		HX_STACK_FRAME("PauseMenu","resumeGame",0xfece7c78,"PauseMenu.resumeGame","PauseMenu.hx",114,0x1d081249)
		HX_STACK_THIS(this)
		HX_STACK_LINE(115)
		this->close();
		HX_STACK_LINE(116)
