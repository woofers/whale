...
::String File_obj::getContent( ::String path){
	HX_STACK_FRAME("sys.io.File","getContent",0xb28b4a0e,"sys.io.File.getContent","D:\\Documents\\Development\\HAXE\\haxe\\std/cpp/_std/sys/io/File.hx",27,0x00539f03)
...
::haxe::io::Bytes File_obj::getBytes( ::String path){
	HX_STACK_FRAME("sys.io.File","getBytes",0xbe457600,"sys.io.File.getBytes","D:\\Documents\\Development\\HAXE\\haxe\\std/cpp/_std/sys/io/File.hx",32,0x00539f03)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(33)
...
bool binary = __o_binary.Default(true);
	HX_STACK_FRAME("sys.io.File","write",0xfec8a9f4,"sys.io.File.write","D:\\Documents\\Development\\HAXE\\haxe\\std/cpp/_std/sys/io/File.hx",53,0x00539f03)
	HX_STACK_ARG(path,"path")
