...
::flixel::util::loaders::SparrowData_obj::__register();
...
::flixel::text::pxText::PxTextAlign_obj::__register();
::flixel::text::pxText::PxFontSymbol_obj::__register();
::flixel::text::pxText::PxDefaultFontGenerator_obj::__register();
...
::flixel::text::FlxBitmapTextField_obj::__register();
...
::PauseMenu_obj::__register();
::flixel::FlxSubState_obj::__register();
::MyInput_obj::__register();
::MyFlxGame_obj::__register();
...
::IMap_obj::__register();
::Lobster_obj::__register();
::List_obj::__register();
::LevelGenerator_obj::__register();
...
::MyFlxGame_obj::__boot();
::MyInput_obj::__boot();
::flixel::FlxSubState_obj::__boot();
::PauseMenu_obj::__boot();
...
::flixel::text::FlxBitmapTextField_obj::__boot();
...
::flixel::text::pxText::PxDefaultFontGenerator_obj::__boot();
::flixel::text::pxText::PxFontSymbol_obj::__boot();
::flixel::text::pxText::PxTextAlign_obj::__boot();
...
::flixel::util::loaders::SparrowData_obj::__boot();
