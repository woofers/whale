...
{
		HX_STACK_FRAME("LevelGenerator","generate",0xbc8bf534,"LevelGenerator.generate","LevelGenerator.hx",52,0x1b8157cf)
		HX_STACK_LINE(53)
...
int LevelGenerator_obj::random( ){
	HX_STACK_FRAME("LevelGenerator","random",0x86c6ea42,"LevelGenerator.random","LevelGenerator.hx",178,0x1b8157cf)
	HX_STACK_LINE(178)
