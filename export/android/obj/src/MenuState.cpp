...
{
		HX_STACK_FRAME("MenuState","create",0xe57b7c18,"MenuState.create","MenuState.hx",34,0xdfbcb22c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(35)
		this->super::create();
		HX_STACK_LINE(38)
		...
		this->bg = _g;
		HX_STACK_LINE(39)
		this->bg->loadGraphic(HX_CSTRING("assets/images/ui/mobile/startScreen.png"),null(),null(),null(),null(),null());
		HX_STACK_LINE(40)
		this->add(this->bg);
	}
return null();
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::flixel::FlxSprite*/ ,(int)offsetof(MenuState_obj,bg),HX_CSTRING("bg")},
	{ hx::fsUnknown, 0, null()}
};
#endif
