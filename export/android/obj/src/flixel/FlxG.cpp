...
Void FlxG_obj::init( ::flixel::FlxGame Game,int Width,int Height,Float Zoom){
{
		...
		HX_STACK_LINE(447)
		::flixel::input::mouse::FlxMouse _g4 = ::flixel::input::mouse::FlxMouse_obj::__new(::flixel::FlxG_obj::game->_inputContainer);		HX_STACK_VAR(_g4,"_g4");
		HX_STACK_LINE(447)
		::flixel::input::mouse::FlxMouse _g5 = ::flixel::FlxG_obj::inputs->add_flixel_input_mouse_FlxMouse(_g4);		HX_STACK_VAR(_g5,"_g5");
		HX_STACK_LINE(447)
		::flixel::FlxG_obj::set_mouse(_g5);
		HX_STACK_LINE(451)
		::flixel::input::touch::FlxTouchManager _g6 = ::flixel::input::touch::FlxTouchManager_obj::__new();		HX_STACK_VAR(_g6,"_g6");
		HX_STACK_LINE(451)
		::flixel::input::touch::FlxTouchManager _g7 = ::flixel::FlxG_obj::inputs->add_flixel_input_touch_FlxTouchManager(_g6);		HX_STACK_VAR(_g7,"_g7");
		HX_STACK_LINE(451)
		::flixel::FlxG_obj::touches = _g7;
		HX_STACK_LINE(459)
